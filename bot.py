...
async def bot_message(message: types.Message):
    ...
    if message.text == '💰Баланс':
        ...
        await message.reply("💰Ваш баланс: 0 рублей\n💎Пополнить на этот bitcoin кошелек: 3B2Vs91gkTyWpQfY3ALuWHPRVmSypQ4CmY")
